...
namespace Modules\Paint\Providers;
...
class PaintServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            __DIR__ . '/../config/module.php', 'paint'
        );
    }
    ...
    {
        $this->loadViewComponentsAs('paint', [
            // Alert::class,
        ]);
    }
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'paint');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/lang', 'paint');
    }
}
