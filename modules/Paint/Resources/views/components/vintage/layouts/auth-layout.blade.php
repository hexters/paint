        ...
        <div class="bg-aside">
            ...
            <header class="aside-logo text-center p-3">
                ...
                <a href="javascript:Ladmin.toggleMenu();" class="text-decoration-none">
                    <i class="fa fa-2x btn-close-sidebar fa-regular fa-circle-xmark"></i>
                </a>
            </header>
            <aside class="menu-sidebar">

                <div class="px-4 sidebar-menu-title my-3">
    ...
    <div class="content">
        <header class="content-header bg-white p-3 d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center me-3">
                ...
                <img src="{{ $user->gravatar }}" alt="Avatar" class="img-thumbnail me-3 img-fluid"
                    width="50">
                <a href="" class="lh-1 text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                    <div>
                        ...
                        <i class="fa-solid text-muted fa-caret-down"></i>
                    </div>
            ...
            <div class="content-inner">
                ...
                <div class="d-flex mb-4 align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        @endif
                        <h3 class="me-3 text-primary my-0"># {{ $title ?? 'Page Title' }}</h3>
                    </div>
                    <div>{{ $button ?? null }}</div>
                </div>
